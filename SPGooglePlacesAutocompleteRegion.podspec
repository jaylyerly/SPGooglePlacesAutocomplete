Pod::Spec.new do |s|
  s.name         = "SPGooglePlacesAutocompleteRegion"
  s.version      = "1.0.4"
  ...
  s.description  = <<-DESC
                   ...
                   DESC
  s.homepage     = "https://github.com/DomainPropertyGroup/SPGooglePlacesAutocomplete"
  s.license      = { :type => 'MIT', :file => 'LICENSE' }
  s.authors      = { "Matej Bukovinski" => "matej@bukovinski.com", "Chris Chen" => "chrischen79@gmail.com" }

  s.platform     = :ios, '6.0'
  s.source       = { :git => "git@github.com:DomainPropertyGroup/SPGooglePlacesAutocomplete.git", :tag => '1.0.4'}
